...
public class DelivererMap extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deliverer_map);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(DelivererMap.this, "Please Register First...", Toast.LENGTH_LONG).show();
//                Intent i = new Intent(DelivererMap.this, Map2.class);
            }
        });
